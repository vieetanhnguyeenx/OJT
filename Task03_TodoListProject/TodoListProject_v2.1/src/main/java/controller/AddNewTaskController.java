...
public class AddNewTaskController implements HttpBaseController, BaseAuthentication {
    @Override
    ...
    public void processPost(PrintWriter writer, OutputStream outputStream, String payload, User user) {
        ...
        TodoDAO.addNewTask(user.getId(), title);
        HTTPServerHelper.responeString(writer, outputStream, "Add Successful");
    }
