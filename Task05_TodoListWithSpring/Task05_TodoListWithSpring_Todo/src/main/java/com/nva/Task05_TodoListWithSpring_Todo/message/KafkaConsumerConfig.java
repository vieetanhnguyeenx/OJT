package com.nva.Task05_TodoListWithSpring_Todo.message;
...
public class KafkaConsumerConfig {
    ...
    @KafkaListener(topics = "add-task-serv", groupId = "addTask-consumer")
    public void listenGroupFoo(String message) {
        if (message != null) {
            Gson gson = new Gson();
            Request request = gson.fromJson(message, Request.class);
            if (request != null) {
                Redis.jedis.hset("addTaskConsumer", request.getId(), message);
