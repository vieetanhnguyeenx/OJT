package com.nva.Task05_TodoListWithSpring_Delete.message;
...
public class KafkaConsumerConfig {
    ...
    @KafkaListener(topics = "delete-task-consumer", groupId = "deleteTask-consumer")
    public void listenGroupFoo(String message) {
        if (message != null) {
            Gson gson = new Gson();
            Request request = gson.fromJson(message, Request.class);
            if (request != null) {
                Redis.jedis.hset("deleteTaskConsumer", request.getId(), message);
